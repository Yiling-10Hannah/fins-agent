...
description: Use when a student says build week context, refresh a week's guidance files, or summarize the current week folder into generated week, data, and output context files.
